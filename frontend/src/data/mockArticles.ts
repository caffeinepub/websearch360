...
export const MOCK_ARTICLES: Article[] = [
  ...
  },
  {
    id: 'pol-2',
    category: 'politics',
    headline: 'EU Parliament Votes to Expand Digital Sovereignty Act Amid Tech Giant Pushback',
    summary: 'European lawmakers voted 412-189 to extend the Digital Sovereignty Act, requiring major technology companies to store EU citizen data exclusively on European servers by 2027. Silicon Valley firms have threatened legal challenges, arguing the measure violates international trade agreements. The European Commission defended the legislation as essential for protecting democratic institutions.',
    source: 'BBC',
  ...
  },
  {
    id: 'pol-3',
    category: 'politics',
    headline: 'Governor Chen Announces 2028 Presidential Bid, Shaking Up Democratic Primary',
    summary: 'California Governor Angela Chen officially entered the 2028 presidential race on Wednesday, becoming the fifth major Democrat to declare candidacy. Her campaign platform centers on climate resilience, universal childcare, and a proposed "Digital New Deal" for rural broadband access. Early polling shows her within striking distance of frontrunner Senator James Holloway.',
    source: 'AP',
  ...
  },
  {
    id: 'pol-4',
    category: 'politics',
    headline: 'Supreme Court Agrees to Hear Landmark AI Liability Case This Fall',
  ...
  },
  {
    id: 'pol-5',
    category: 'politics',
    headline: 'UK Prime Minister Faces No-Confidence Vote After Budget Controversy',
    summary: 'British Prime Minister David Harrington faces a no-confidence motion after his government\'s emergency budget sparked widespread protests across England and Scotland. The budget included a 3% increase in income tax for middle earners and cuts to public pension benefits. Opposition leader Sarah Okafor called the measures "a betrayal of ordinary British families."',
    source: 'BBC',
  ...
  },
  {
    id: 'pol-6',
    category: 'politics',
    headline: 'G20 Summit Ends With Fragile Agreement on Global Minimum Corporate Tax',
    summary: 'Leaders of the world\'s twenty largest economies concluded their annual summit with a tentative agreement to enforce a 15% global minimum corporate tax rate, though three nations withheld full endorsement. The deal, if ratified, would close offshore tax havens used by multinational corporations to shelter an estimated $800 billion annually. Implementation is expected to begin in 2027.',
    source: 'Reuters',
  ...
  },
  {
    id: 'pol-8',
    category: 'politics',
    headline: 'NATO Expands Rapid Response Force to 100,000 Troops Amid Eastern Tensions',
    summary: 'NATO defense ministers agreed to double the alliance\'s rapid response force to 100,000 troops, the largest expansion since the Cold War. The decision follows increased military activity along the alliance\'s eastern flank and comes with a commitment from member states to raise defense spending to 2.5% of GDP. Secretary General Rutte called the move "a clear signal of unity and resolve."',
    source: 'Reuters',
  ...
  },
  {
    id: 'nat-3',
    category: 'national',
    headline: 'New High-Speed Rail Corridor Connecting Chicago to Detroit Opens to Passengers',
    summary: 'The Midwest Express Rail Corridor officially opened Tuesday, cutting travel time between Chicago and Detroit from five hours to under two hours. The $28 billion project, a decade in the making, is the first new high-speed rail line in the United States since Amtrak\'s Acela expansion. Officials expect the line to carry 4 million passengers annually by 2028.',
    source: 'CNN',
    timestamp: hoursAgo(3),
    severity: 'normal',
    breaking: false,
  ...
  },
  {
    id: 'nat-5',
    category: 'national',
    headline: 'Congress Approves $50 Billion Affordable Housing Act to Address National Crisis',
  ...
  },
  {
    id: 'nat-7',
    category: 'national',
    headline: 'Border Security Bill Fails in Senate After Last-Minute Defections',
    summary: 'A comprehensive border security and immigration reform bill fell three votes short of the 60 needed to advance in the Senate, dealing a significant blow to the administration\'s legislative agenda. The bill would have added 5,000 border agents, established new asylum processing centers, and created a pathway to legal status for 2 million undocumented immigrants. Negotiations are expected to resume after the congressional recess.',
    source: 'Fox News',
    timestamp: hoursAgo(7),
    severity: 'normal',
    breaking: false,
  ...
  // ===== INTERNATIONAL =====
  {
    ...
    headline: 'China and India Sign Historic Border Demarcation Agreement After 60 Years',
    summary: 'In a landmark diplomatic breakthrough, China and India signed a comprehensive border demarcation agreement resolving territorial disputes that have simmered since the 1962 war. The deal, brokered with assistance from the United Nations, establishes a 20-kilometer buffer zone along the Line of Actual Control. Both nations agreed to withdraw troops from contested areas within 90 days.',
    source: 'Al Jazeera',
    timestamp: hoursAgo(1),
    severity: 'breaking',
    breaking: true,
  ...
  },
  {
    id: 'int-3',
    category: 'international',
    headline: 'Japan Announces $500 Billion Green Energy Transition Plan by 2035',
    summary: 'Japanese Prime Minister Tanaka unveiled an ambitious plan to achieve 80% renewable energy by 2035, backed by $500 billion in public and private investment. The strategy includes offshore wind farms, next-generation nuclear reactors, and a national hydrogen distribution network. Japan aims to become the world\'s first major economy to achieve carbon neutrality by 2045.',
    source: 'Reuters',
    timestamp: hoursAgo(3),
    severity: 'normal',
    breaking: false,
  ...
  },
  {
    id: 'int-5',
    category: 'international',
    headline: 'South Korea and North Korea Hold First Direct Talks in Seven Years',
    summary: 'Delegations from South Korea and North Korea met at the Panmunjom truce village for the first direct diplomatic talks since 2019, raising cautious hopes for a reduction in tensions on the Korean Peninsula. The discussions focused on family reunification programs and the possibility of reopening the Kaesong Industrial Complex. A follow-up meeting is scheduled for next month.',
    source: 'BBC',
    timestamp: hoursAgo(5),
    severity: 'normal',
    breaking: false,
  },
  {
    ...
    summary: 'Mexico\'s GDP surpassed France\'s for the first time in history, making it the world\'s sixth largest economy according to IMF data released Thursday. The milestone reflects a decade of nearshoring investment as companies relocated manufacturing from Asia to North America. Mexico\'s manufacturing sector grew 8.3% in 2025, driven by automotive, electronics, and aerospace industries.',
    source: 'Reuters',
    timestamp: hoursAgo(6),
    severity: 'normal',
    breaking: false,
  },
  {
    ...
    summary: 'Australia\'s government unveiled a $368 billion defense spending plan over the next decade, the largest military expansion in the country\'s history. The package includes nuclear-powered submarines under the AUKUS agreement, long-range missile systems, and a doubling of the Australian Defence Force\'s active personnel. Prime Minister Walsh cited "a fundamentally changed strategic environment" in the Indo-Pacific.',
    source: 'Reuters',
    timestamp: hoursAgo(7),
    severity: 'normal',
    breaking: false,
  },
  {
    id: 'int-8',
    category: 'international',
    headline: 'WHO Declares End to Mpox Global Health Emergency After Vaccine Rollout Success',
  ...
  // ===== SPORTS =====
  {
    id: 'spo-1',
    category: 'sports',
    headline: 'LeBron James Jr. Signs Record $350 Million NBA Contract with Los Angeles Lakers',
    summary: 'Bronny James, son of NBA legend LeBron James, signed a five-year, $350 million maximum contract extension with the Los Angeles Lakers, becoming the highest-paid player in NBA history. The 22-year-old guard averaged 28.4 points, 7.2 assists, and 5.1 rebounds per game last season. The deal surpasses the previous record set by his father in 2023.',
    source: 'ESPN',
  ...
  },
  {
    id: 'spo-3',
    category: 'sports',
    headline: 'Serena Williams\' Daughter Alexis Wins First Grand Slam at Australian Open',
    summary: 'Alexis Ohanian Jr., 19, claimed her first Grand Slam title at the Australian Open, defeating world number one Iga Swiatek 6-4, 3-6, 7-5 in a thrilling final. The American teenager, who turned professional just two years ago, becomes the youngest Australian Open champion since Maria Sharapova in 2008. Her mother Serena Williams watched from the players\' box in tears.',
    source: 'AP',
    timestamp: hoursAgo(3),
    severity: 'normal',
    breaking: false,
  ...
  },
  {
    id: 'spo-8',
    category: 'sports',
    headline: 'Golden State Warriors Win NBA Championship in Six Games Over Boston Celtics',
    summary: 'The Golden State Warriors captured their sixth NBA championship in franchise history, defeating the Boston Celtics 4-2 in the Finals. Stephen Curry, at 38, was named Finals MVP after averaging 31.2 points per game in the series. The victory gives Curry his fifth championship ring, tying him with Kobe Bryant on the all-time list.',
    source: 'ESPN',
    timestamp: hoursAgo(8),
    severity: 'normal',
    breaking: false,
  ...
  // ===== WAR =====
  {
    id: 'war-1',
    category: 'war',
    headline: '⚠️ CRITICAL: Nuclear Facility in Eastern Europe Reports Radiation Leak After Drone Strike',
    summary: 'A nuclear power facility in eastern Ukraine reported a radiation leak following a precision drone strike on its cooling infrastructure, triggering emergency protocols and evacuation orders for a 30-kilometer radius. The International Atomic Energy Agency has dispatched an emergency response team and is monitoring radiation levels. NATO has called an emergency session and described the attack as "a red line that cannot be crossed."',
    source: 'Reuters',
  ...
  },
  {
    id: 'war-2',
    category: 'war',
    headline: 'Israel and Iran Exchange Missile Strikes in Escalating Regional Conflict',
    summary: 'Israel launched a series of precision airstrikes on Iranian military installations in response to a ballistic missile barrage that struck Tel Aviv\'s outskirts, killing 12 civilians. Iran\'s Revolutionary Guard vowed "devastating retaliation" while the United States deployed two additional carrier strike groups to the Persian Gulf. The UN Security Council convened an emergency session as world leaders urged de-escalation.',
    source: 'Al Jazeera',
    timestamp: minutesAgo(45),
    severity: 'critical',
    breaking: true,
  },
  {
    id: 'war-3',
    category: 'war',
    headline: 'Ukraine Launches Largest Drone Offensive Deep Into Russian Territory',
    summary: 'Ukraine deployed over 500 long-range drones in a coordinated strike on Russian oil refineries, military depots, and railway infrastructure, marking the deepest penetration into Russian territory since the war began. Russian air defenses intercepted approximately 60% of the drones, but significant damage was reported at three major fuel storage facilities. The Kremlin called the attack "an act of terrorism" and promised a severe response.',
    source: 'BBC',
    timestamp: hoursAgo(1),
    severity: 'breaking',
    breaking: true,
  ...
  },
  {
    id: 'war-6',
    category: 'war',
    headline: 'Taiwan Strait Tensions Spike as China Conducts Largest Military Exercise in Decade',
    summary: 'China\'s People\'s Liberation Army launched its largest military exercise around Taiwan in ten years, deploying 80 warships, 200 aircraft, and conducting live-fire drills within 20 nautical miles of the island. Taiwan scrambled its air force and placed its military on high alert. The United States called the exercises "destabilizing and provocative" and urged Beijing to stand down.',
    source: 'Reuters',
    timestamp: hoursAgo(4),
    severity: 'breaking',
    breaking: true,
  ...
  },
  {
    id: 'bus-2',
    category: 'business',
    headline: 'Global Recession Fears Mount as Manufacturing PMI Falls to 18-Month Low',
    summary: 'The global manufacturing Purchasing Managers\' Index fell to 47.2 in February, its lowest reading in 18 months and the fourth consecutive month below the 50-point expansion threshold. Economists at Goldman Sachs raised their probability of a global recession within 12 months to 35%. The data triggered a broad selloff in equity markets, with the Dow Jones falling 2.3%.',
    source: 'Bloomberg',
    timestamp: hoursAgo(1),
    severity: 'breaking',
    breaking: true,
  },
  {
    ...
    summary: 'Amazon announced the acquisition of Boston Dynamics from Hyundai for $8.5 billion, its largest deal since the MGM purchase in 2021. The acquisition gives Amazon access to Boston Dynamics\' advanced humanoid and quadruped robots, which the company plans to deploy in its fulfillment centers and delivery operations. The deal is subject to regulatory approval and is expected to close by year-end.',
    source: 'Reuters',
    timestamp: hoursAgo(2),
    severity: 'normal',
    breaking: false,
  },
  {
    id: 'bus-4',
    category: 'business',
    headline: 'OPEC+ Cuts Oil Production by 1.5 Million Barrels Per Day, Sending Prices Surging',
    summary: 'OPEC+ members agreed to reduce oil production by 1.5 million barrels per day starting next month, sending crude oil prices up 8% to $94 per barrel. The surprise cut, led by Saudi Arabia and Russia, comes amid concerns about weakening global demand. Analysts warn the move could reignite inflation in major economies and complicate central bank policy decisions.',
    source: 'Reuters',
    timestamp: hoursAgo(3),
    severity: 'breaking',
    breaking: true,
  ...
  },
  {
    id: 'bus-6',
    category: 'business',
    headline: 'Bitcoin Surges Past $180,000 as Institutional Adoption Accelerates',
    summary: 'Bitcoin reached a new all-time high of $182,400 on Thursday, driven by record inflows into spot Bitcoin ETFs and announcements from three major sovereign wealth funds that they have added Bitcoin to their portfolios. Total assets under management in Bitcoin ETFs surpassed $500 billion for the first time. Analysts at JPMorgan raised their 12-month price target to $250,000.',
    source: 'Bloomberg',
    timestamp: hoursAgo(5),
    severity: 'normal',
    breaking: false,
  ...
  },
  {
    id: 'tec-6',
    category: 'technology',
    headline: 'Quantum Computing Startup Achieves 10,000-Qubit Milestone, Threatening Current Encryption',
    summary: 'IonQ announced it has achieved a stable 10,000-qubit quantum computer, a milestone that experts say brings practical quantum computing within reach and poses a credible threat to current RSA and elliptic curve encryption standards. The U.S. National Institute of Standards and Technology immediately urged organizations to accelerate migration to post-quantum cryptography. The announcement triggered emergency meetings at major financial institutions.',
    source: 'Reuters',
    timestamp: hoursAgo(5),
    severity: 'breaking',
    breaking: true,
  },
  {
    id: 'tec-7',
    category: 'technology',
    headline: 'EU Fines Meta $4.2 Billion for Systematic GDPR Violations in AI Training',
    summary: 'The European Data Protection Board issued a record $4.2 billion fine against Meta for using European users\' personal data to train its AI models without proper consent, the largest GDPR penalty in history. Meta has 90 days to appeal and must immediately cease using EU user data for AI training. The ruling sets a precedent that could affect every major AI company operating in Europe.',
    source: 'BBC',
    timestamp: hoursAgo(6),
    severity: 'normal',
    breaking: false,
  ...
  // ===== SCIENCE =====
  {
    id: 'sci-1',
    category: 'science',
    headline: 'NASA\'s Europa Clipper Discovers Evidence of Active Hydrothermal Vents on Jupiter\'s Moon',
  ...
  },
  {
    id: 'sci-2',
    category: 'science',
    headline: 'Scientists Reverse Aging in Human Cells by 30 Years Using New Epigenetic Therapy',
    summary: 'Researchers at the Salk Institute published results showing a new epigenetic reprogramming therapy successfully reversed cellular aging markers by the equivalent of 30 years in human skin and blood cells. The therapy, which uses a cocktail of four proteins, showed no signs of causing cancer in extensive safety testing. Clinical trials in elderly patients are expected to begin in 2027.',
    source: 'Nature',
    timestamp: hoursAgo(2),
    severity: 'normal',
    breaking: false,
  ...
  },
  {
    id: 'sci-7',
    category: 'science',
    headline: 'Scientists Successfully Grow Functional Human Kidney in Lab for First Time',
  ...
  },
  {
    id: 'sci-8',
    category: 'science',
    headline: 'Astronomers Detect Strongest Evidence Yet for Parallel Universe in CMB Data',
    summary: 'A team of cosmologists analyzing data from the Planck satellite and the South Pole Telescope identified anomalous cold spots in the cosmic microwave background that are statistically consistent with a collision between our universe and a parallel universe approximately 380,000 years after the Big Bang. The finding, published in Physical Review Letters, has a significance of 4.2 sigma. Independent verification is underway.',
    source: 'Nature',
    timestamp: hoursAgo(8),
    severity: 'normal',
    breaking: false,
  ...
  // ===== HEALTH =====
  {
    id: 'hea-1',
    category: 'health',
    headline: '⚠️ CRITICAL: Novel H5N2 Bird Flu Strain Shows Human-to-Human Transmission in Southeast Asia',
  ...
  },
  {
    id: 'hea-2',
    category: 'health',
    headline: 'Alzheimer\'s Drug Lecanemab Shows 45% Reduction in Cognitive Decline in Phase 3 Trial',
    summary: 'Eisai and Biogen reported that their Alzheimer\'s drug lecanemab demonstrated a 45% reduction in cognitive decline in a 3,000-patient Phase 3 clinical trial, the most effective result ever achieved in Alzheimer\'s treatment. The drug, which targets amyloid plaques in the brain, showed benefits across all stages of the disease. The FDA is expected to grant priority review for an expanded indication.',
    source: 'Reuters',
    timestamp: hoursAgo(1),
    severity: 'normal',
    breaking: false,
  },
  {
    id: 'hea-3',
    category: 'health',
    headline: 'WHO Recommends Universal mRNA Vaccine Platform for Future Pandemic Preparedness',
  ...
  },
  {
    id: 'hea-5',
    category: 'health',
    headline: 'Universal Cancer Vaccine Shows 90% Efficacy in Early Clinical Trials',
    summary: 'BioNTech announced preliminary results from Phase 1/2 trials of its personalized mRNA cancer vaccine showing 90% efficacy in preventing cancer recurrence across 12 different tumor types. The vaccine, which is customized to each patient\'s specific tumor mutations, was tested in 340 patients with advanced cancers. Full Phase 3 trials are expected to begin in 2027.',
    source: 'Reuters',
    timestamp: hoursAgo(4),
    severity: 'breaking',
    breaking: true,
  },
  {
    id: 'hea-6',
    category: 'health',
    headline: 'Mental Health Crisis Among Teenagers Reaches Epidemic Proportions, CDC Reports',
  ...
  },
  {
    id: 'hea-7',
    category: 'health',
    headline: 'Antibiotic-Resistant Superbug Outbreak Spreads to 15 Countries, WHO Warns',
  ...
  },
  {
    id: 'ent-3',
    category: 'entertainment',
    headline: 'Marvel Announces "Avengers: Rebirth" with Original Cast Returning via De-Aging Technology',
    summary: 'Marvel Studios announced "Avengers: Rebirth," a new film that will feature the original Avengers cast — including Robert Downey Jr. and Scarlett Johansson — using advanced AI de-aging technology to portray their characters at peak age. The film, set for a 2027 release, has already generated $400 million in advance ticket sales. Industry analysts predict it will become the highest-grossing film of all time.',
    source: 'Variety',
    timestamp: hoursAgo(3),
    severity: 'normal',
    breaking: false,
  },
  {
    id: 'ent-4',
    category: 'entertainment',
    headline: 'Beyoncé\'s "Renaissance III" Album Debuts at Number One in 87 Countries Simultaneously',
    summary: 'Beyoncé\'s "Renaissance III" debuted at number one in 87 countries simultaneously, breaking the record for the most simultaneous chart-toppers in music history. The album, which blends Afrobeats, classical orchestration, and electronic music, received universal critical acclaim with a perfect 100 score on Metacritic. The accompanying visual album will premiere exclusively on Apple TV+ next month.',
    source: 'Variety',
    timestamp: hoursAgo(4),
    severity: 'normal',
    breaking: false,
  ...
  },
  {
    id: 'ent-6',
    category: 'entertainment',
    headline: 'Video Game Industry Surpasses $300 Billion in Annual Revenue for First Time',
    summary: 'The global video game industry generated $312 billion in revenue in 2025, surpassing the $300 billion milestone for the first time and exceeding the combined revenues of the film and music industries. Mobile gaming accounted for 52% of total revenue, while cloud gaming grew 78% year-over-year. The industry now employs more than 2.5 million people worldwide.',
    source: 'Reuters',
    timestamp: hoursAgo(6),
    severity: 'normal',
    breaking: false,
  ...
  },
  {
    id: 'wea-2',
    category: 'weather',
    headline: 'Magnitude 7.8 Earthquake Strikes Tokyo, Triggering Tsunami Warning',
    summary: 'A powerful 7.8 magnitude earthquake struck 45 kilometers off the coast of Tokyo at 6:23 AM local time, triggering a tsunami warning for the entire Pacific coast of Japan. The Japan Meteorological Agency is warning of waves up to 5 meters. Tokyo\'s emergency management system activated immediately, with millions of residents receiving evacuation alerts on their mobile devices.',
    source: 'Reuters',
  ...
  },
  {
    id: 'wea-4',
    category: 'weather',
    headline: 'Massive Wildfire Complex Threatens Los Angeles, 500,000 Under Evacuation Orders',
    summary: 'A rapidly expanding wildfire complex driven by 70 mph Santa Ana winds has forced evacuation orders for 500,000 residents across Los Angeles County, with flames threatening neighborhoods in the San Fernando Valley and Malibu. The fires have already consumed 85,000 acres and destroyed over 3,000 structures. Governor Chen has declared a state of emergency and requested federal disaster assistance.',
    source: 'CNN',
    timestamp: hoursAgo(2),
    severity: 'breaking',
    breaking: true,
  ...
  },
  {
    id: 'wea-6',
    category: 'weather',
    headline: 'Flooding in Bangladesh Displaces 4 Million as Monsoon Season Intensifies',
    summary: 'Catastrophic flooding across Bangladesh has displaced 4 million people and submerged one-third of the country following the most intense monsoon season in recorded history. The floods have destroyed 200,000 homes and damaged critical infrastructure including roads, bridges, and water treatment facilities. The Bangladesh government has declared a national emergency and appealed for international humanitarian assistance.',
    source: 'Al Jazeera',
    timestamp: hoursAgo(4),
    severity: 'breaking',
    breaking: true,
  },
  {
    id: 'wea-7',
    category: 'weather',
    headline: 'Sahara Desert Experiences Unprecedented Snowfall for Third Time in Five Years',
    summary: 'Parts of the Sahara Desert in Algeria and Morocco received significant snowfall for the third time in five years, a phenomenon that was virtually unheard of before 2021. Meteorologists attribute the unusual weather to disruptions in the jet stream caused by Arctic warming. While visually striking, scientists warn the event is a symptom of the broader climate disruption affecting global weather patterns.',
    source: 'Reuters',
    timestamp: hoursAgo(5),
    severity: 'normal',
    breaking: false,
