...
import { Sun, Moon, Settings, Wifi } from 'lucide-react';
...
export default function Header({ darkMode, onToggleDarkMode, onOpenSettings, userName }: HeaderProps) {
  return (
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 flex-shrink-0">
          ...
          <div className="flex items-baseline gap-1">
            <span className="font-display text-lg font-bold text-foreground tracking-tight">WebSearch</span>
            <span className="font-display text-lg font-bold neon-text tracking-tight">360</span>
          </div>
