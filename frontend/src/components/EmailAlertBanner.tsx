...
export default function EmailAlertBanner({ alerts, onDismiss }: EmailAlertBannerProps) {
          ...
          <div className="flex items-start gap-3 p-4 rounded-xl bg-red-950/95 border border-red-500/50 shadow-glass-lg backdrop-blur-sm">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-red-300 text-xs font-semibold uppercase tracking-wide">Email Alert Sent</span>
              </div>
              <p className="text-white text-sm font-medium leading-snug">
                Alert sent to <span className="text-red-300 font-semibold">{alert.email}</span>
              </p>
