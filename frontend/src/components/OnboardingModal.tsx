...
import { Globe, Mail, User, Bell, X } from 'lucide-react';
          ...
          <div className="p-8">
            ...
            <div className="flex items-center justify-center mb-6">
              <div className="relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-500/30 flex items-center justify-center">
                  <img src="/assets/generated/globe-radar-icon.dim_128x128.png" alt="WebSearch360" className="w-10 h-10 object-contain" />
                </div>
            ...
            <div className="mb-6 p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 flex gap-3">
              ...
              <p className="text-sm text-amber-200/80">
                We'll notify you by email only when a <strong className="text-amber-300">MAJOR disaster or catastrophic event</strong> occurs worldwide — earthquakes, tsunamis, nuclear events, or mass casualty incidents.
              </p>
            </div>
              ...
              <label className="flex items-start gap-3 p-3 rounded-xl bg-white/5 border border-white/10 cursor-pointer hover:bg-white/8 transition-colors">
                <div className="relative mt-0.5">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-all ${emailDelivery ? 'bg-cyan-500 border-cyan-500' : 'border-white/30 bg-transparent'}`}>
                    {emailDelivery && (
                ...
                <div>
                  <p className="text-sm font-medium text-foreground">Enable Email Delivery Mode</p>
                  <p className="text-xs text-muted-foreground mt-0.5">Receive instant email alerts for disaster-level events</p>
                </div>
              </label>
